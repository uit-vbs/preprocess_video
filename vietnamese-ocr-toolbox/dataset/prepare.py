...
def extract_mcocr(
    data_dir="./data/mcocr_public/mcocr_train_data/", out_dir="./data/ocr_data/"
):
...
def coco_convert(data_dir, out_path):
    ...
    my_dict = {"images": [], "annotations": [], "categories": []}
...
def convert_sroie19_to_coco(data_dir="./data/SROIE2019", out_dir="./data/sroie19"):
