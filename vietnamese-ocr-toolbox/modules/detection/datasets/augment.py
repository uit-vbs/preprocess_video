...
class DataAugment:
    ...
    def random_scale(
        self, im: np.ndarray, text_polys: np.ndarray, scales: np.ndarray or list
    ) -> tuple:
        """
    ...
    def random_rotate_img_bbox(
        self,
        img,
        text_polys,
        degrees: numbers.Number or list or tuple or np.ndarray,
        same_size=False,
    ):
        """
    ...
    def resize(
        ...
        input_size: numbers.Number or list or tuple or np.ndarray,
        ...
        if isinstance(input_size, numbers.Number):
            ...
            or isinstance(input_size, tuple)
            or isinstance(input_size, np.ndarray)
        ):
            if len(input_size) != 2:
