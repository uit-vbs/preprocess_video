...
parser.add_argument(
    "--print_per_iter", type=int, default=10, help="Number of iteration to print"
)
parser.add_argument(
    "--val_interval",
    type=int,
...
parser.add_argument(
    "--save_interval", type=int, default=50, help="Number of steps between saving"
)
parser.add_argument(
    "--resume",
    type=str,
...
parser.add_argument(
    "--freeze_backbone", action="store_true", help="whether to freeze the backbone"
)
